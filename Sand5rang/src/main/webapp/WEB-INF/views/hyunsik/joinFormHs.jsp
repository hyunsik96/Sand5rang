...
.inquiry_wrapper{width:1300px; background-color:rgb(234 234 234); margin:auto; padding:70px 49px; border:1px solid #e8e8e8;}
...
<form action="insertStore.hs" method="post" id="enroll-form">
                          ...
                          <td>
                              ...
                              <span class="form_text" style="width:200px">
                                  <input style="width:350px;" id="checkemail" maxlength="5" name="checkemail" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" 
                                  			type="text" placeholder="인증번호를 입력하세요" value="" readonly required>
